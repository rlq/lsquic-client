...
do
  ...
  cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_FLAGS:STRING="${CFLAGS}" -DCMAKE_CXX_FLAGS:STRING="${CPPFLAGS}" -DCMAKE_OSX_SYSROOT="${PLATFORM}" -DCMAKE_OSX_ARCHITECTURES="${ARCH}"
